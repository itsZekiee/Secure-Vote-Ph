    ...
    $forms = $forms instanceof Collection ? $forms : collect($forms);
        ...
        <div x-data="{
            ...
            showSuccess: false,
                ...
                /*
                  RULES:
                  - First name: letters, optional "Ma."
                  - Middle name: optional, letters only
                  - Last name: letters only
                  - Optional suffix: Jr., II, III, IV, V
                */
                const regex = /^(Ma\.\s)?[A-Za-z]+(\s[A-Za-z]+)?\s[A-Za-z]+(\s(Jr\.|II|III|IV|V))?$/;
            ...
            } else if (!this.isValidFullName(this.formData.full_name)) {
                this.errors.full_name = [
                    'Enter a valid full name (letters only, Ma. allowed, no email)'
                ];
            }
            ...
            if (!this.formData.form_id) {
                this.errors.form_id = ['Election selection is required'];
            }
                                        ...
                                        <div class="space-y-1.5">
                                            ...
                                            <div class="relative group">
                                                ...
                                                <input type="text"
                                                            ...
                                                            @input="formData.full_name = formData.full_name.replace(/[^A-Za-z.\s]/g, '')"
                                                            placeholder="e.g., Ma. Clara Santos"
