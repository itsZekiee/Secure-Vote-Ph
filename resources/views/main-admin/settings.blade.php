                            ...
                            <div class="p-8">
                                <div class="flex items-center justify-between mb-8">
                                    ...
                                    <div class="flex gap-2">
                                        <a href="{{ route('admin.settings.backup') }}" class="p-2 text-slate-400 hover:text-indigo-600 transition-colors" title="Download Backup">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <!-- Basic Info -->
                                    <div class="space-y-6">
                                        <h4 class="text-xs font-bold text-slate-400 uppercase tracking-wider">General Settings</h4>
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Site Name</label>
                                            <input type="text" name="site_name" value="{{ $settings['site_name']->value ?? 'SecureVote PH' }}"
                                                   class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all px-4 py-3 bg-slate-50 focus:bg-white">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Contact Email</label>
                                            <input type="email" name="contact_email" value="{{ $settings['contact_email']->value ?? 'admin@securevote.ph' }}"
                                                   class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all px-4 py-3 bg-slate-50 focus:bg-white">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-semibold text-slate-700 mb-2">Site Description</label>
                                            <textarea name="site_description" rows="3"
                                                      class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 transition-all px-4 py-3 bg-slate-50 focus:bg-white">{{ $settings['site_description']->value ?? '' }}</textarea>
                                        </div>
                                    </div>

                                    <!-- Features Toggle -->
                                    <div class="space-y-6">
                                        <h4 class="text-xs font-bold text-slate-400 uppercase tracking-wider">Features Control</h4>
                                        <div class="space-y-4">
                                            <label class="flex items-center justify-between p-4 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition-colors">
                                                <div>
                                                    ...
                                                    <span class="block text-xs text-slate-500">Enable site maintenance</span>
                                                </div>
                                            ...
                                            <label class="flex items-center justify-between p-4 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition-colors">
                                                <div>
                                                    <span class="block text-sm font-bold text-slate-800">Results Visibility</span>
                                                    <span class="block text-xs text-slate-500">Make election results public</span>
                                                </div>
                                            ...
                                            <label class="flex items-center justify-between p-4 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition-colors">
                                                <div>
                                                    ...
                                                    <span class="block text-xs text-slate-500">Send system alerts via email</span>
                                                </div>
