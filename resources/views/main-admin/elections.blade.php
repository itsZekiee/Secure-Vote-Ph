        ...
        <main class="flex-1">
                ...
                <div class="px-8 py-4">
                    <div class="flex items-center justify-between gap-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-gray-900">Create New Election</h1>
                                <p class="text-sm text-gray-600 leading-relaxed">Set up a comprehensive election with positions, candidates, and voting configurations</p>
                            </div>
                        </div>
                        ...
                        <nav class="flex items-center" aria-label="Breadcrumb">
                            <ol class="flex items-center gap-3">
                                <li>
                                    <a href="{{ route('admin.elections.index') }}" class="flex items-center text-sm text-gray-500 hover:text-gray-700 transition-colors">
            ...
            <div class="p-8">
                <form id="electionForm" action="{{ route('admin.elections.store') }}" method="POST"
                    ...
                    <!-- Progress Stepper -->
                    <div class="mb-8">
                        <div class="flex items-center justify-between bg-white p-6 border border-gray-200 rounded-xl shadow-sm">
                            <div class="w-full">
