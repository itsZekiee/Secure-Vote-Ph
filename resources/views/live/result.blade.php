    ...
    <div class="min-h-screen bg-slate-50">
        ...
        <header class="glass-header sticky top-0 z-50 px-4 py-3">
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                <a href="{{ route('voter.elections.welcome', $election->code) }}" class="flex items-center gap-2 text-brand-primary font-bold hover:opacity-70 transition-opacity text-sm">
