...
@section('content')
    <div x-data="{
                ...
                // IMPORTANT: draft is NOT deleted
                this.showToast('Form cleared. You can load the saved draft anytime.', 'info');
                },
        ...
        this.currentStep = 1;
        this.validationPassed = this.validateForm();
        ...
        <div x-show="showSuccessModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div x-show="showSuccessModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="p-8 text-center">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                    ...
                    <p class="text-gray-600 mb-6">Your new organization has been created and is ready for use. You'll be
                        redirected to the organizations list shortly.</p>
        ...
        <div x-show="showErrorModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div x-show="showErrorModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="p-8 text-center">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-red-500 to-rose-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                                ...
                                <ol class="flex items-center space-x-2">
                                    <li>
                                        <a href="{{ route('admin.dashboard') }}"
                                            class="text-[9px] font-black text-slate-400 hover:text-indigo-600 transition-colors uppercase tracking-widest">Dashboard</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.organizations.index') }}"
                                            class="text-[9px] font-black text-slate-400 hover:text-indigo-600 transition-colors uppercase tracking-widest">Organizations</a>
                                    </li>
                                    <li>
                                        <i class="ri-arrow-right-s-line text-slate-300"></i>
                                    </li>
                                    <li class="flex items-center">
                                        <span class="text-[9px] font-black text-indigo-700 uppercase tracking-widest">Create
                                            New</span>
                                    </li>
                                </ol>
                            </nav>
                    ...
                    <div class="flex items-start justify-between mb-8">
                        <div class="flex items-start space-x-6">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl shadow-blue-500/25 transform hover:rotate-3 transition-transform">
                                    <i class="ri-building-add-line text-white text-2xl"></i>
                                </div>
                            </div>
                            <div>
                                <h1 class="text-3xl font-black text-slate-900 mb-1 uppercase tracking-tight">Create
                                    Organization</h1>
                                <p class="text-sm text-slate-500 font-bold mb-4">Set up a new organization to manage members
                                    and activities</p>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-[9px] font-black uppercase tracking-widest"
                                            :class="currentStep === 1 ? 'text-slate-900' : 'text-slate-400'">Basic
                                            Info</span>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-[9px] font-black uppercase tracking-widest"
                                            :class="currentStep === 2 ? 'text-slate-900' : 'text-slate-400'">Review &
                                            Submit</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-12 gap-8">
                        ...
                        <div class="col-span-12 lg:col-span-8">
                            ...
                            <div x-show="currentStep === 1" x-transition:enter="transition ease-out duration-300"
                                ...
                                <form @submit.prevent="nextStep()" class="space-y-6">
                                    ...
                                    <div
                                        class="bg-white rounded-3xl border border-slate-200/60 shadow-xl shadow-slate-200/40 overflow-hidden">
                                        <div class="px-8 py-5 bg-slate-50/50 border-b border-slate-100">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    <div
                                                        class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-indigo-600 shadow-sm border border-slate-100">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p
                                                            ...
                                                            Primary Identity Info</p>
                                                    </div>
                                                </div>
                                                <span
                                                    class="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-[9px] font-black uppercase tracking-widest">Step
                                                    01</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-8 space-y-6">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="relative group">
                                                    <i
                                                        class="ri-building-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors"></i>
                                                    <input type="text" x-model="formData.name"
                                                        ...
                                                        placeholder="e.g. Supreme Student Council" required>
                                                </div>
                                                <template x-if="errors.name">
                                                    <p class="text-rose-500 text-[9px] font-bold uppercase tracking-wider mt-1 ml-1"
                                            ...
                                            <div class="space-y-2">
                                                <label
                                                    class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">
                                                    Description <span
                                                        class="text-slate-400 font-bold text-[8px] tracking-normal lowercase">(optional)</span>
                                                </label>
                                                ...
                                                <div class="flex justify-between items-center px-1">
                                                    <p
                                                        ...
                                                        Brief overview of the organization</p>
                                                    <span class="text-[9px] font-black text-slate-400 uppercase"
                                                        x-text="`${formData.description?.length || 0}/500`"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="relative">
                                                    <i
                                                        class="ri-toggle-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 z-10"></i>
                                                    ...
                                                    <i
                                                        class="ri-arrow-down-s-line absolute right-4 top-1/2 -translate-y-1/2 text-slate-400"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="px-8 py-5 bg-slate-50/50 border-b border-slate-100">
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-emerald-600 shadow-sm border border-slate-100">
                                        ...
                                        <div class="p-8 space-y-6">
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div class="relative group">
                                                        <i
                                                            class="ri-mail-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-600 transition-colors"></i>
                                                        <input type="email" x-model="formData.contact_email"
                                                            ...
                                                            placeholder="org@example.com" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <div class="relative group">
                                                        <i
                                                            class="ri-phone-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-600 transition-colors"></i>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p
                                                    ...
                                                    Validate information before finalizing</p>
                                            </div>
                                        </div>
                                ...
                                <form @submit.prevent="submitForm()" class="space-y-6">
                                    <div
                                        ...
                                        <div class="px-8 py-5 bg-slate-50/50 border-b border-slate-100">
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-purple-600 shadow-sm border border-slate-100">
                                        ...
                                        <div class="p-8 space-y-6">
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div class="space-y-1.5">
                                                    <label
                                                        class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Organization
                                                        Name</label>
                                                    <p x-text="formData.name"
                                                        class="text-sm font-bold text-slate-900 bg-slate-50 px-4 py-3 rounded-xl border border-slate-100">
                                                    </p>
                                                </div>
                                                <div class="space-y-1.5">
                                                    <label
                                                        class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Status</label>
                                                    <div class="flex">
                                                        <span x-text="formData.status"
                                                            class="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-[10px] font-black uppercase tracking-widest border border-indigo-100 capitalize"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="space-y-1.5">
                                                <label
                                                    class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Description</label>
                                                <p x-text="formData.description || 'No description provided'"
                                                    class="text-sm font-bold text-slate-700 bg-slate-50 px-4 py-3 rounded-xl border border-slate-100 min-h-[80px] leading-relaxed">
                                                </p>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div class="space-y-1.5">
                                                    <label
                                                        class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Official
                                                        Email</label>
                                                ...
                                                <div class="space-y-1.5">
                                                    <label
                                                        class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">Phone
                                                        Number</label>
                                                    <div class="flex items-center gap-2 text-slate-900 font-bold text-sm">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                <p class="text-sm font-black text-slate-900 uppercase tracking-tight">Ready
                                                    to Create</p>
                                                <p
                                                    class="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            <div class="sticky top-32 space-y-6">
                                <!-- Progress Card -->
                                <div
                                    class="bg-white rounded-3xl border border-slate-200/60 shadow-xl shadow-slate-200/40 p-6">
                                    <h4 class="text-xs font-black text-slate-900 mb-6 uppercase tracking-widest">Setup
                                        Progress</h4>
                                    <div class="space-y-4">
                                        <div class="flex items-center justify-between">
                                            <span
                                                class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Completion</span>
                                            <span class="text-sm font-black text-indigo-600"
                                                x-text="Math.round((Object.values(formData).filter(v => v !== '').length / Object.keys(formData).length) * 100) + '%'"></span>
                                        </div>
                                ...
                                <!-- Pro Tips Card -->
                                <div
                                    class="bg-gradient-to-br from-indigo-600 to-blue-600 rounded-3xl p-6 text-white shadow-xl shadow-indigo-100">
                                    ...
                                    <ul class="space-y-3">
                                        <li class="flex items-start space-x-3">
                                            ...
                                            <p class="text-[11px] font-bold text-indigo-50 leading-relaxed">Use a
                                                professional name for institutional recognition.</p>
                                        </li>
                                        <li class="flex items-start space-x-3">
                                            <i class="ri-checkbox-circle-fill text-emerald-400 mt-0.5"></i>
                                            <p class="text-[11px] font-bold text-indigo-50 leading-relaxed">Ensure the
                                                contact email is regularly monitored.</p>
                                        </li>
                                        <li class="flex items-start space-x-3">
                                            <i class="ri-checkbox-circle-fill text-emerald-400 mt-0.5"></i>
                                            <p class="text-[11px] font-bold text-indigo-50 leading-relaxed">Descriptions
                                                help members understand your core mission.</p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div
                                    class="bg-white rounded-3xl border border-slate-200/60 shadow-xl shadow-slate-200/40 p-6">
                                    <h4 class="text-xs font-black text-slate-900 mb-6 uppercase tracking-widest">Utility
                                        Panel</h4>
                                    <div class="space-y-3">
