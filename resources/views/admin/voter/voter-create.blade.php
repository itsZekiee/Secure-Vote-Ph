    ...
    <div x-data="{
        ...
        if (phone) {
            ...
            if (!phonePattern.test(phone)) {
                this.errors.phone = ['Invalid Philippine phone number. Must start with 09 and be 11 digits'];
            }
        }
            ...
            return Object.keys(this.errors).length === 0;   
                ...
                }" x-init="generateVoterCode()" class="min-h-screen bg-slate-50 flex">
        ...
        <main class="flex-1">
            ...
            <div class="max-w-6xl mx-auto px-6 py-8">
                ...
                <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl shadow-indigo-100">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-slate-500 font-bold tracking-widest uppercase mt-0.5">Register a new
                                verified voter</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <section class="lg:col-span-8">
                        <form @submit.prevent="submit()" class="space-y-6">
                            ...
                            <div
                                class="bg-white rounded-3xl border border-slate-200/60 shadow-2xl shadow-slate-200/50 overflow-hidden">
                                <div
                                    class="px-8 py-5 bg-slate-50/50 border-b border-slate-100 flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-8 h-8 bg-white rounded-lg flex items-center justify-center text-indigo-600 shadow-sm">
                                            <i class="ri-information-line text-lg"></i>
                                        </div>
                                        <h3 class="text-base font-black text-slate-800 uppercase tracking-tight">Voter
                                            Details</h3>
                                    </div>
                                    <span
                                        class="px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full text-[9px] font-black uppercase tracking-widest border border-emerald-100">Auto
                                        Approved</span>
                                </div>
                                ...
                                <div class="p-8 space-y-8">
                                    ...
                                    <div class="space-y-1.5">
                                        <label
                                            class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Voter
                                            ID (Preview)</label>
                                        <div class="flex gap-3 items-center">
                                            <div class="relative flex-1 group">
                                                <i
                                                    class="ri-fingerprint-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i>
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="relative group">
                                            <i
                                                class="ri-user-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors"></i>
                                        ...
                                        <div x-show="errors.full_name"
                                            class="text-rose-500 text-[9px] font-bold uppercase tracking-wider mt-1 ml-1"
                                            x-text="errors.full_name?.[0]"></div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div class="space-y-1.5">
                                            ...
                                            <div class="relative group">
                                                <i
                                                    class="ri-mail-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors"></i>
                                        ...
                                        <div class="space-y-1.5">
                                            ...
                                            <div class="relative group">
                                                <i
                                                    class="ri-phone-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors"></i>
                                                <input type="tel" x-model="formData.phone" placeholder="09XXXXXXXXX"
                                                    maxlength="11"
                                                    @input="formData.phone = formData.phone.replace(/\D/g,'').slice(0,11)"
                                                    :class="errors.phone ? 'ring-2 ring-rose-500' : ''"
                                                    class="w-full bg-slate-50 border-none rounded-xl px-12 py-3 text-xs font-bold text-slate-700 focus:ring-4 focus:ring-indigo-500/10 focus:bg-white transition-all shadow-sm">
                                            </div>
                                            <div x-show="errors.phone"
                                                class="text-rose-500 text-[9px] font-bold uppercase tracking-wider mt-1 ml-1"
                                                x-text="errors.phone?.[0]"></div>
                                        </div>
                                        ...
                                        <div class="space-y-1.5">
                                            <label
                                                ...
                                                Election <span class="text-rose-500">*</span></label>
                                            <div class="relative group">
                                                <i
                                                    class="ri-qr-code-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors z-10"></i>
                                            ...
                                            <div x-show="errors.form_id"
                                                class="text-rose-500 text-[9px] font-bold uppercase tracking-wider mt-1 ml-1"
                                                x-text="errors.form_id?.[0]"></div>
                                        </div>

                                        <!-- Notes -->
                                        <div class="space-y-1.5">
                                            <label
                                                class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Notes
                                                (Optional)</label>
                                    ...
                                    <!-- Actions -->
                                    <div
                                        class="px-8 py-6 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between">
                                        <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">New voters
                                            are automatically verified.</p>
                                        <div class="flex items-center gap-3">
                        ...
                        <!-- General Errors -->
                        <div x-show="Object.keys(errors).length && errors.general" x-transition
                            class="mt-4 p-3.5 bg-rose-50 border border-rose-100 rounded-xl flex items-center gap-3 text-rose-600">
                        ...
                        <div class="sticky top-28 space-y-6">
                            ...
                            <div class="bg-white rounded-3xl border border-slate-200/60 shadow-xl shadow-slate-200/40 p-6">
                                <div class="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 class="text-base font-black text-slate-800 uppercase tracking-tight">Voter Preview
                                    </h3>
                                </div>

                                <div class="space-y-5">
                                    <div
                                        class="flex flex-col items-center py-5 mb-5 bg-slate-50/50 rounded-2xl border border-slate-100">
                                        <div
                                            class="w-16 h-16 bg-white rounded-xl flex items-center justify-center text-slate-300 shadow-sm border border-slate-100 mb-3">
                                            <i class="ri-user-3-line text-2xl"></i>
                                        </div>
                                        <p class="text-base font-black text-slate-800 tracking-tight"
                                            x-text="formData.full_name || 'Full Name'"></p>
                                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-0.5"
                                            x-text="formData.voter_code"></p>
                                    </div>

                                    <div class="space-y-3">
                                        <div class="flex justify-between items-center px-1">
                                            <span
                                                class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Email</span>
                                            <span class="text-[11px] font-bold text-slate-700 truncate max-w-[120px]"
                                                x-text="formData.email || '—'"></span>
                                        </div>
                                        <div class="flex justify-between items-center px-1">
                                            <span
                                                class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Phone</span>
                                            <span class="text-[11px] font-bold text-slate-700"
                                                x-text="formData.phone || '—'"></span>
                                        </div>
                                        <div class="flex justify-between items-center px-1">
                                            <span
                                                class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Election</span>
                                            <span
                                                class="text-[11px] font-bold text-slate-700 text-right truncate max-w-[120px]"
                                                x-text="formData.form_id ? (document.querySelector('#form-select option[value=\'' + formData.form_id + '\']')?.textContent || 'Selected') : 'Not selected'"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Tips -->
                            <div
                                class="bg-gradient-to-br from-indigo-600 to-blue-600 rounded-3xl p-6 text-white shadow-xl shadow-indigo-200">
                                ...
                                <ul class="space-y-3">
                                    <li class="flex items-start gap-2.5">
                                        ...
                                        <p class="text-[11px] font-bold text-indigo-50 leading-relaxed">Ensure the email
                                            address is correct for automatic invitation delivery.</p>
                                    </li>
                                    <li class="flex items-start gap-2.5">
                                        <i class="ri-checkbox-circle-line text-emerald-400 mt-0.5"></i>
                                        <p class="text-[11px] font-bold text-indigo-50 leading-relaxed">Voter codes are
                                            unique identifiers used for security during voting.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div x-show="showSuccess" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl border border-slate-100 text-center">
                    <div
                        class="w-20 h-20 mx-auto rounded-2xl bg-emerald-50 flex items-center justify-center mb-6 shadow-inner">
                    ...
                    <p class="text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-8">Profile has been
                        registered and verified successfully.</p>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <button
                            @click="showSuccess = false; $nextTick(()=>generateVoterCode()); formData.full_name=''; formData.email=''; formData.phone=''; formData.form_id='';"
