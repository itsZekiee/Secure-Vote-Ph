...
@section('content')
        <div x-data="{
                ...
                --------------------------*/
                saveDraft() {
                    localStorage.setItem('partylist_draft', JSON.stringify({
                        name: this.formData.name,
                        acronym: this.formData.acronym,
                        description: this.formData.description,
                        platform: this.formData.platform,
                        color: this.formData.color,
                        organization_id: this.formData.organization_id,
                        election_id: this.formData.election_id,
                ...
                loadDraft() {
                    ...
                    this.formData.acronym = data.acronym || '';
                    this.formData.description = data.description || '';
                    this.formData.platform = data.platform || '';
                    this.formData.color = data.color || '#3b82f6';
                    this.formData.organization_id = data.organization_id || '';
                    this.formData.election_id = data.election_id || '';
        ...
        // IMPORTANT: DO NOT DELETE DRAFT
        showNotification('Form cleared. You can load the saved draft anytime.', 'info');
    },
                ...
                async submitForm() {
                    ...
                    if (!confirm('Are you sure you want to create this partylist?')) return;
                    ...
                    try {
                        ...
                        Object.keys(this.formData).forEach(key => {
                            if (this.formData[key] !== null && this.formData[key] !== '') {
                                ...
                                } else if (!['logo', 'logoName'].includes(key)) {
                        ...
                        if (response.ok && data.success) {
                            ...
                            showNotification('Partylist created successfully', 'success');
                ...
                generateAcronym() {
                    if (this.formData.name) {
                        this.formData.acronym = this.formData.name
                            .split(' ')
                            .map(w => w[0])
                            .join('')
                            .toUpperCase()
