...
<body>
    ...
    <p><strong>Election Link:</strong> <a href="{{ route('voter.registration.index', $election->id) }}?mode=signin">{{ route('voter.registration.index', $election->id) }}?mode=signin</a></p>
