                ...
                <div x-data="passwordRecovery()">
                    ...
                    <div x-show="step === 2" x-cloak class="space-y-6">
                        <div class="text-center mb-6">
                            <p class="text-sm text-slate-600">We've sent a 6-digit code to <span class="font-bold text-slate-900" x-text="email"></span></p>
                        </div>
                        <div>
                            <label for="otp" class="block text-sm font-semibold text-slate-700 mb-2">
                                Enter 6-Digit OTP
                            </label>
                            <input id="otp" x-model="otp" type="text" maxlength="6"
                    ...
                    <div x-show="message" :class="messageType === 'success' ? 'bg-green-50 text-green-600 border-green-200' : 'bg-red-50 text-red-600 border-red-200'"
                        class="mt-4 p-4 border rounded-xl text-sm" x-text="message">
                    </div>
                </div>

                <div class="mt-6 text-center">
                    <a href="{{ route('voter.registration.index', $election->id) }}" class="text-sm font-semibold text-brand-accent hover:underline">
                        Back to Login
                    </a>
                </div>
            </div>
