                            ...
                            <div class="gradient-brand p-8 text-center relative overflow-hidden">
                                ...
                                <div class="relative">
                                    <div
                                        ...
                                        <i id="form-header-icon" class="fas fa-sign-in-alt text-white text-2xl"></i>
                                    </div>
                                    <h2 id="form-header-title" class="text-2xl font-bold text-white mb-2">Welcome Back
                                    </h2>
                                    <p id="form-header-subtitle" class="text-white/80 text-sm">Sign in to access your election</p>
                                </div>
                            </div>
                                            ...
                                            <div>
                                                ...
                                                @if(str_contains($errors->first('login'), 'permanently blocked') || str_contains($errors->first('login'), 'contact the Administrator'))
                                                    <div class="mt-3 p-3 bg-white rounded-lg border border-red-100 shadow-sm">
                                                        <p class="text-xs font-bold text-slate-800 mb-1 uppercase tracking-wider">
                                                            How to restore access?</p>
                                                        <p class="text-xs text-slate-500">Please send an email to <span
                                                                class="text-brand-accent font-bold">admin@securevote.ph</span> or
                                                            contact your organization's IT department.</p>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                @if($registrationOver)
                                    <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                                        <div class="flex items-start gap-3 text-amber-700">
                                            ...
                                            <div>
                                                <p class="font-bold">Sign in to vote</p>
                                                <p class="text-sm">Please sign in with your credentials to cast your vote for this election.</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                    ...
                    <div class="order-1 lg:order-2 lg:sticky lg:top-8">
                        <div class="mb-8">
                            ...
                            <h1 class="text-4xl lg:text-5xl font-bold text-brand-primary mb-4 leading-tight">
                                Cast Your <span class="text-brand-accent">Vote</span><br>Securely
                            </h1>
                            <p class="text-lg text-slate-600 leading-relaxed">
                                Sign in to your account and participate in secure, transparent elections. Your voice matters.
                            </p>
                        </div>
                        ...
                        <div class="space-y-5">
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 text-sm">Your data and your vote are protected with enterprise-grade encryption.</p>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-500 text-sm">Sign in with your credentials and start voting immediately.</p>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            @if($election->require_geo_registration)
                ...
                const f = document.getElementById('signin-form');
                if (f) {
                    f.addEventListener('submit', function (e) {
                        if (!loginLatInput.value || !loginLngInput.value) {
                            e.preventDefault();
                            getGeoLocation(() => {
                                if (f.requestSubmit) {
                                    f.requestSubmit();
