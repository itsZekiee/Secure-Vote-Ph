    ...
    <div class="min-h-screen bg-[#F5F5F5] py-12 px-4 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto relative z-10">
            ...
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl lg:text-5xl font-black text-brand-primary mb-4 tracking-tight">{{ $election->title }}</h1>
                <p class="text-slate-500 text-lg">Official Digital Ballot for Election Code: <span class="font-mono font-bold text-brand-accent">{{ $election->code }}</span></p>
            </div>
                ...
                <div class="p-8 lg:p-12">
                    <div class="flex flex-col md:flex-row items-center gap-8 mb-12">
                        ...
                        <div class="text-center md:text-left">
                            <h2 class="text-2xl lg:text-3xl font-bold text-brand-primary mb-1">Welcome back, {{ $voter['name'] }}!</h2>
                            <p class="text-slate-400">Your identity has been verified. You are authorized to participate in this election.</p>
                        </div>
                        @if(!$hasVoted)
                            <div class="ml-auto">
                                <span class="px-4 py-2 bg-emerald-50 text-emerald-600 rounded-xl text-sm font-bold border border-emerald-100">
                    ...
                    <div class="bg-brand-primary rounded-[2.5rem] p-10 lg:p-14 text-white shadow-2xl shadow-brand-primary/30 mb-12 relative overflow-hidden">
                        ...
                        <div class="absolute bottom-0 left-0 w-64 h-64 bg-brand-accent/10 rounded-full -ml-32 -mb-32 blur-3xl"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div id="countdown" class="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
                                ...
                                <div class="relative group">
                                    <div class="bg-brand-accent rounded-3xl p-6 lg:p-8 shadow-xl shadow-brand-accent/20 transition-transform hover:scale-105">
                                        <div id="seconds" class="text-4xl lg:text-6xl font-black mb-1">00</div>
                                        <div class="text-[10px] lg:text-xs font-bold uppercase tracking-widest text-white/80">Secs</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-6">
                        @if($hasVoted)
                            <div class="flex-1 py-6 bg-emerald-50 text-emerald-600 font-black rounded-3xl text-center border-2 border-emerald-100 flex items-center justify-center gap-3">
            ...
            <div class="text-center">
                <a href="{{ route('voter.elections.access') }}" class="inline-flex items-center gap-2 text-slate-400 font-bold hover:text-brand-primary transition-colors py-2 px-4 rounded-xl hover:bg-white shadow-none hover:shadow-sm">
